...
public class JornadaDAO {
	 ...
	 * 
	 * @return -1 en caso de que no haya jornadas, la jornada en caso de que haya
	 *         una
	 */
	...
	/**
	 * metode per a recuperar tots els partits de una jornada
	 * 
	 * @param numJornada : el numero de jornada del que s'han de recuperar partits
	 * @return : una llista d'objectes tipus Partit
	 */
	...
	/**
	 * metode per actualitzar els resultats dels partits
	 * 
	 * @param numJornada : la jornada del partit
	 * @param equipA     : un dels equips
	 * @param equipB     : el altre equip
	 * @param golsA      : gols del primer equip introduit
	 * @param golsB      : gols del segon equip introduit
	 */
