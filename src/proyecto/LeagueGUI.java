...
public class LeagueGUI extends JFrame {
	...
	/**
	 * funcio utilitzada per carregar la jornada actual
	 */
	...
	private void saveResults() {
		try {
			...
			for (int i = 0; i < currentMatches.size(); i++) {
				...
				controlador.guardarResultatDesDeGUI(jornadaActual, match.getEquipLocal().getNom(),
						match.getEquipVisitant().getNom(), golsL, golsV);
			}
