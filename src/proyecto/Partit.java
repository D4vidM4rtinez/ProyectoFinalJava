...
public class Partit {
    ...
    private Integer golsVisitant; // Usem Integer per admetre NULL a la BBDD
    ...
    public Integer getGolsLocal() { return golsLocal; }
    public void setGolsLocal(Integer golsLocal) { this.golsLocal = golsLocal; }
    
    public Integer getGolsVisitant() { return golsVisitant; }
    public void setGolsVisitant(Integer golsVisitant) { this.golsVisitant = golsVisitant; }
